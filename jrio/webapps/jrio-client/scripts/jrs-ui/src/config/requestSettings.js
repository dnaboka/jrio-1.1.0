 ...
 * @version: $Id: requestSettings.js 11672 2018-02-20 13:56:05Z dgorbenk $
 */
...
define(function (require) {
    ...
    var settings = require("common/config/requestSettings"),
        configs = require("jrs.configs"),
        locale = configs.userLocale.replace(/_/g, "-");

    settings.headers["Accept-Language"] = locale;
