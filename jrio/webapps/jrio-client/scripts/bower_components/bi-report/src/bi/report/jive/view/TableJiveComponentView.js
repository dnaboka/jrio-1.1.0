...
define(function (require) {
    ...
    function onHeaderToolbarSelect(buttonView, buttonModel, e) {
        ...
        _.isFunction(this[message]) && this[message](buttonModel, buttonView.$el);
    }
    ...
    return BaseJiveComponentView.extend({
        ...
        filter: function(actionModel, $target){
            this.filterDialog.open(this.currentColumn, $target.offset());
        },

        format: function(actionModel, $target){
            this.formatDialog.open(this.currentColumn, $target.offset());
        },
