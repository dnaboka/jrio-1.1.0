    ...
    JiveComponentCollectionView.prototype = {
        initSubviews: function() {
            ...
            this.collection.forEach(function(component) {
                ...
                component.get("type") === "chart" && viewModules.push("bi/chart/jr/jive/highcharts/view/ChartJiveComponentView") && viewModels.push(component);
                component.get("type") === "fusionMap" && viewModules.push("./FusionComponentView") && viewModels.push(component);
                component.get("type") === "fusionChart" && viewModules.push("./FusionComponentView") && viewModels.push(component);
                component.get("type") === "fusionWidget" && viewModules.push("./FusionComponentView") && viewModels.push(component);
                component.get("type") === "googlemap" && viewModules.push("./GooglemapComponentView") && viewModels.push(component);
                component.get("type") === "tibco-maps" && viewModules.push("./TibcomapComponentView") && viewModels.push(component);
                component.get("type") === "CVComponent" && viewModules.push("./CustomJiveComponentView") && viewModels.push(component);

                component.get("type") === "table" && viewModules.push("./TableJiveComponentView") && viewModels.push(component);
                component.get("type") === "crosstab" && viewModules.push("./CrosstabJiveComponentView") && viewModels.push(component);
            });
